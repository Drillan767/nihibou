...
class StripsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create strip" do
    assert_difference('Strip.count') do
      post strips_url, params: { strip: { description: @strip.description, image: @strip.image, strip_number: @strip.strip_number, titre: @strip.titre } }
    end
  ...
  test "should update strip" do
    patch strip_url(@strip), params: { strip: { description: @strip.description, image: @strip.image, strip_number: @strip.strip_number, titre: @strip.titre } }
