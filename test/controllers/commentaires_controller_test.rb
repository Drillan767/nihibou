...
class CommentairesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create commentaire" do
    assert_difference('Commentaire.count') do
      post commentaires_url, params: { commentaire: { email: @commentaire.email, message: @commentaire.message, pseudo: @commentaire.pseudo } }
    end
  ...
  test "should update commentaire" do
    patch commentaire_url(@commentaire), params: { commentaire: { email: @commentaire.email, message: @commentaire.message, pseudo: @commentaire.pseudo } }
